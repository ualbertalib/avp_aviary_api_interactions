...
#       output: CSV
#       input: CSV from the Aviary web UI resource export (to workaround API limits number of results from the collection resource listing API call with no pagination information 2023-03-27)
#       exploritory / proof-of-concept code
# usage: python3 aviary_api_report_media_csv_by_resource_list.py --server ${aviary_server_name} --output ${output_path} -input ${input_path}
